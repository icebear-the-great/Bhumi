...
service cloud.firestore {
  match /databases/{database}/documents {
    match /{document=**} {
      ...
      {notification && (
        <div className={`fixed bottom-6 right-6 px-6 py-4 rounded-xl shadow-2xl z-50 flex items-center gap-3 animate-fade-in-up border ${notification.type === 'success' ? 'bg-bhumi-900 text-white border-bhumi-800' : 'bg-red-50 text-red-700 border-red-200'
          }`}>
